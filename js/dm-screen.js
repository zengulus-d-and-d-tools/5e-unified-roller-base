(function () {
    ...
    const DEFAULT_COVERAGE = {
        jurisdiction: 'Customary influence varies by region and local rulers',
    ...
    const DEFAULT_DM_DATA = {
        ...
        dm: {
            actions: {
                General: [
                    'inspecting fresh hoofprints near a river ford',
                    'questioning a wary innkeeper before dawn',
                    'scouting ridge lines for signs of a hidden lookout'
                ],
                Independent: [
                    'peddling suspect relics from a tarp-covered mule cart',
                    'shadowing travelers from tree line to tree line',
                    'offering directions that may hide an agenda'
                ],
                Env: [
                    'cold rain turns trails into sucking mud',
                    'market-day crowds choke the main road',
            ...
            textures: {
                struct: {
                    a: ['A braced oak gate', 'A narrow stone corridor', 'A cracked keep support'],
                ...
                guts: {
                    a: ['A rune-etched waystone', 'A pressure-fed alchemy still', 'A bell-pull signal line'],
                    b: ['protecting the hall from intrusion', 'feeding lamps and braziers', 'warning nearby lookouts'],
                    c: ['flickering unpredictably', 'hissing and overheating', 'failing in short bursts']
                },
                debris: {
                    a: ['A snapped signet ring', 'A blood-specked map scrap', 'A dropped pouch of lockpicks'],
                    b: ['beside a side-hall door', 'in a shadowed alcove', 'scattered across trampled straw'],
            ...
            npcs: [
                ...
                { w: 'Avoid being named before the local lord', l: 'A marked key they cannot explain' },
                ...
                { w: 'Win reassignment to safer patrols', l: 'Unlogged gaps in their patrol roster' },
                { w: 'Keep the village calm at all costs', l: 'A firsthand account they tried to bury' },
                { w: 'Expand influence within their company', l: 'A stolen seal used on forged orders' },
            ...
            papers: [
                { n: 'Traveling Broadsheet', t: 'Neutral', e: 'No immediate impact' },
                { n: 'Temple Bulletin', t: 'Concerned', e: 'Heat +1 (public scrutiny)' },
                { n: 'Merchants Ledger Notes', t: 'Practical', e: 'Heat -1 (if resolved swiftly)' },
                { n: 'Scribes Almanac', t: 'Analytical', e: 'No immediate impact' },
                { n: 'Keep Notice', t: 'Summary', e: 'No immediate impact' },
                { n: 'Roadside Pamphlet', t: 'Speculative', e: 'Heat +1 (rumors spread)' }
            ],
            guildRefs: []
        }
    };
