...
## Card Anatomy
- **Header** – Title plus tier tag (`Routine`, `Standard`, `Elite`, `Boss`). Inline select menus let you change location, objective, or tier without reopening the form.
...
- **Meta & Notes** – Location/objective fields plus the logged timestamp and notes box keep each recipe searchable and practical for scaling advice.
...
3. **Run the Scene** – Keep the card open while adjudicating. Update fields in place; everything auto-saves.
